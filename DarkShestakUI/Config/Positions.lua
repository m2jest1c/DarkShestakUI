...
C["position"] = {
	...
	["quest"] = {"RIGHT", UIParent, "RIGHT", -90, 129},							-- Quest log
	["loot"] = {"TOPLEFT", UIParent, "TOPLEFT", 245, -220},							-- Loot
	["group_loot"] = {"BOTTOM", UIParent, "BOTTOM", -238, 500},						-- Group roll loot
	["threat_meter"] = {"BOTTOMLEFT", ActionButton12, "BOTTOMRIGHT", 107, 16},		-- Threat meter
	["raid_cooldown"] = {"TOPLEFT", UIParent, "TOPLEFT", 357, -21},					-- Raid cooldowns
	...
	["right_bars"] = {"RIGHT", UIParent, "RIGHT", -24, 0},							-- Right bars
	["pet_horizontal"] = {"BOTTOMRIGHT", UIParent, "BOTTOM", -175, 167},			-- Horizontal pet bar
	["stance_bar"] = {"TOPLEFT", UIParent, "TOPLEFT", 323, -21},				-- Stance bar
	["vehicle_bar"] = {"BOTTOMRIGHT", ActionButton1, "BOTTOMLEFT", -98, 0},			-- Vehicle button
	["micro_menu"] = {"TOPLEFT", UIParent, "TOPLEFT", 21, -21},						-- Micro menu
	-- UnitFrame positions
	unitframes = {
		["player"] = {"BOTTOMRIGHT", "ActionBarAnchor", "TOPLEFT", 117, 100},		-- Player frame
		["target"] = {"BOTTOMLEFT", "ActionBarAnchor", "TOPRIGHT", -117, 100},			-- Target frame
		...
		["party_heal"] = {"TOPLEFT", UIParent, "TOPLEFT", 23, -60},			-- Heal layout Party frames
		["raid_heal"] = {"TOPLEFT", UIParent, "TOPLEFT", 23, -60},			-- Heal layout Raid frames
		...
		["arena"] = {"BOTTOMRIGHT", UIParent, "RIGHT", -135, -70},					-- Arena frames
		["boss"] = {"BOTTOMRIGHT", UIParent, "RIGHT", -98, -70},					-- Boss frames
